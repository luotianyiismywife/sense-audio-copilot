...
"Failed to generate commit message:": "生成提交消息失败：",
	...
	"SenseAudio-VL-1.0 — vision-language model": "SenseAudio-VL-1.0 — 视觉语言模型",
	"SenseAudio-VL-Lite-1.0 — lightweight vision-language model": "SenseAudio-VL-Lite-1.0 — 轻量级视觉语言模型",
