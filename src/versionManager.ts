...
export class VersionManager {
    ...
    static getVersion(): string {
        if (this._version === null) {
            const extension = vscode.extensions.getExtension("luotianyiismywife.senseaudio-copilot-provider");
    ...
    static getUserAgent(): string {
        ...
        return `senseaudio-copilot/${this.getVersion()} VSCode/${vscodeVersion}`;
    }
